...
public class Optional_02_Test {
    ...
    public void test_optional_map() throws Exception {
        ...
        Optional<Integer> julesAge = julesOpt.map(age -> age.getAge());
    ...
    public void test_optional_ifPresent() throws Exception {
        ...
        // TODO utiliser la méthode isPresent pour vérifier que l'age est bien 30, 
        //déclencher l'exception GoodException pour valider que la fonction en paramètre de ifPresent a bien été exécutée.
