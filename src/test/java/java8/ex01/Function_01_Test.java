...
public class Function_01_Test {
    ...
    private Function<Integer, Person> intToPerson = (entier) ->{
    	...
    	Person p = new Person("first_" + entier, "last_" + entier, entier, "pass_" + entier);
    ...
    private Function<Integer, Account> intToAccountWithCompose = (entier) -> {
    	
    	return personToAccount.compose(intToPerson).apply(entier);	
    };
    ...
    private Function<Integer, Account> intToAccountWithAndThen = (entier) -> {
    	return intToPerson.andThen(personToAccount).apply(entier);
    };
